...
set arrow from 2131.08,0 to 2131.08,220 lc rgb "black" lt 1 lw 1.5 dt 4 nohead
set label 'Walltime' at 1905,150
set label 'Referenz' at 1905,140
...
set output 'Residuum_Walltime_adjoint.jpg'
f(x)=1.0928e-07
g(y)=1291.4
...
plot '2_timeparallel_1/adjointlogtable2.csv' using 6:3 with linespoints lc rgb 'green' title '2 Intervalle' , \
'4_timeparallel_1/adjointlogtable4.csv' using 6:3 with linespoints lc rgb 'orange' title '4 Intervalle' , \
'5_timeparallel_1/adjointlogtable5.csv' using 6:3 with linespoints lc rgb 'blue' title '5 Intervalle' , \
'10_timeparallel_1/adjointlogtable10.csv' using 6:3 with linespoints lc rgb 'black' title '10 Intervalle' , \
'20_timeparallel_1/adjointlogtable20.csv' using 6:3 with linespoints lc rgb 'cyan' title '20 Intervalle', \
